...
MathJax.Extension.lang_enus = {
	...
	uppercaseWordText: "UpperWord",

	leftParenVerboseText: "left-parenthesis",
	leftParenBriefText: "left-p'ren",
	leftParenSuperBriefText: "L p'ren",
	rightParenVerboseText: "right-parenthesis",
	...
	functionOf: function() {
		return this.functionOfText + " ";
	},

	numberIndicator: function(v) {
		if (v === 0) { //verbosity is set to verbose		
			return this.numberVerboseText + " ";
		}
		return this.numberBriefText + " ";
	},

	numberSign: function(v) {
		if (v === 0) {
			return this.numberSignVerboseText + " ";
		}
		return this.numberSignBriefText + " ";
	},

	parenText: function(item, v) {
		if (item === "(") {
			if (v === 0) { //verbose
				return this.leftParenVerboseText + " ";
			} else if (v === 1) { //brief
				return this.leftParenBriefText + " ";
			} else { //superbrief
				return this.leftParenSuperBriefText + " ";
			}
		} else {
			if (v === 0) {
				return this.rightParenVerboseText + " ";
			} else if (v === 1) {
				return this.rightParenBriefText + " ";
			} else {
				return this.rightParenSuperBriefText + " ";
			}
		}
	},
	...
	getCharMathSpeak: function(c, chex, v) {
		...
		} else if (this.mocodes[chex]) {
			return this.mocodes[chex] + " ";
		} else if (c === "#") {
			return this.numberSign(v);
		} else {
			return c + " ";
		}
	},
	...
	casePrefix: function(len, isLower) {
		if (len > 1) { //use word prefix
			if (isLower) {
				...
				return this.uppercaseWordText + " ";
			}
		} else {
			if (isLower) {
				return this.lowercaseCharText + " ";
			} else {
	...
	greek: {
		"370" : "Upper Heta",
		"371" : "Heta",
		"372" : "Upper Archaic Sampi",
		"373" : "Archaic Sampi",
		"374" : "Numeral Sign",
		"375" : "Lower Numeral Sign",
		"376" : "Upper Pamphylian Digamma",
		"377" : "Pamphylian Digamma",
		"37A" : "Ypogegrammeni",
		"37B" : "Reversed Lunate Sigma",
		"37C" : "Dotted Lunate Sigma",
		"37D" : "Reversed Dotted Lunate Sigma",
		"37E" : "Question Mark",
		"384" : "Tonos",
		"385" : "Dialytika Tonos",
		"386" : "Upper Alpha Tonos",
		"387" : "Ano Teleia",
		"388" : "Upper Epsilon Tonos",
		"389" : "Upper Eta Tonos",
		"38A" : "Upper Iota Tonos",
		"38C" : "Upper Omicron Tonos",
		"38E" : "Upper Upsilon Tonos",
		"38F" : "Upper Omega Tonos",
		"390" : "Iota Dialytika And Tonos",
		"391" : "Upper Alpha",
		"392" : "Upper Beta",
		"393" : "Upper Gamma",
		"394" : "Upper Delta",
		...
		"3A8" : "Upper Psi",
		"3A9" : "Upper Omega",
		"3AA" : "Upper Iota Dialytika",
		"3AB" : "Upper Upsilon Dialytika",
		"3AC" : "Alpha Tonos",
		"3AD" : "Epsilon Tonos",
		"3AE" : "Eta Tonos",
		"3AF" : "Iota Tonos",
		"3B0" : "Upsilon Dialytika And Tonos",
		"3B1" : "Alpha",
		"3B2" : "Beta",
		"3B3" : "Gamma",
		"3B4" : "Delta",
		...
		"3E0" : "Sampi",
		"3E1" : "Sampi",
		"3E2" : "Coptic Upper Shei",
		"3E3" : "Coptic  Shei",
		"3E4" : "Coptic Upper Fei",
		"3E5" : "Coptic  Fei",
		"3E6" : "Coptic Upper Khei",
		"3E7" : "Coptic  Khei",
		"3E8" : "Coptic Upper Hori",
		"3E9" : "Coptic  Hori",
		"3EA" : "Coptic Upper Gangia",
		"3EB" : "Coptic  Gangia",
		"3EC" : "Coptic Upper Shima",
		"3ED" : "Coptic  Shima",
		"3EE" : "Coptic Upper Dei",
		"3EF" : "Coptic  Dei",
		"3F0" : "Kappa",
		"3F1" : "Rho",
		"3F2" : "Lunate Sigma",
		...
		"3F7" : "Upper Sho",
		"3F8" : "Sho",
		"3F9" : "Upper Lunate Sigma",
		"3FA" : "Upper San",
		"3FB" : "San",
		"3FC" : "Rho Stroke",
		"3FD" : "Upper Reversed Lunate Sigma",
		"3FE" : "Upper Dotted Lunate Sigma",
		"3FF" : "Upper Reversed Dotted Lunate Sigma"
	},
	...
	mocodes: {
		...
		"25B4" : "black up-pointing  triangle",
		"25B5" : "white up-pointing  triangle",
		"25B6" : "black right-pointing triangle",
		"25B7" : "white right-pointing triangle",
		"25B8" : "black right-pointing  triangle",
		"25B9" : "white right-pointing  triangle",
		"25BC" : "black down-pointing triangle",
		"25BD" : "white down-pointing triangle",
		"25BE" : "black down-pointing  triangle",
		"25BF" : "white down-pointing  triangle",
		"25C0" : "black left-pointing triangle",
		"25C1" : "white left-pointing triangle",
		"25C2" : "black left-pointing  triangle",
		"25C3" : "white left-pointing  triangle",
		"25C4" : "black left-pointing pointer",
		"25C5" : "white left-pointing pointer",
		"25C6" : "black diamond",
		"25C7" : "white diamond",
		"25C8" : "white diamond containing black  diamond",
		"25C9" : "fisheye",
		"25CC" : "dotted circle",
		...
		"29B2" : "empty set with  circle above",
		...
		"29BF" : "circled bullet",
		"29C2" : "circle with  circle to the right",
		...
		"@" : "commercial at",
		"?" : "question mark",
		"2145" : "double-struck italic Upper d",
		"2146" : "double-struck italic  d",
		"221A" : "square root",
		"221B" : "cube root",
		"221C" : "fourth root",
...
MathJax.Ajax.loadComplete("[MathJax]/extensions/Language/lang_enus.js");
